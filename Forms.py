from wtforms import Form, StringField, IntegerField, SelectField, TextAreaField, validators, DecimalField, PasswordField
...
class CreateCustomerForm(Form):
    ...
    points = IntegerField('Points', [validators.NumberRange(min=0), validators.Optional()])
    password = PasswordField('Password', [validators.length(min=5, max=15), validators.data_required()])
